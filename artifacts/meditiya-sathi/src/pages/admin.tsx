...
// Outsider Donations - Super Admin & Admin
    ...
    // T-Shirt Registration - Super Admin & Admin
    ...(canManageFestivals ? [{ name: 'T-Shirt Registration', icon: Shirt, count: 0, color: 'text-teal-500', href: '/admin/tshirt-registrations' }] : []),

// T-Shirt Registration - Volunteer (assigned festivals)
    ...(isVolunteer ? [{ name: 'T-Shirt Registration', icon: Shirt, count: 0, color: 'text-teal-500', href: '/admin/tshirt-registrations' }] : []),
