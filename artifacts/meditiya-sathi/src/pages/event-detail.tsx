...
export default function EventDetail() {
  ...
  return <>
    ...
    {isLoading ? <main className="min-h-screen pt-32 text-center text-muted-foreground">Loading event...</main> : isError || !event ? <main className="min-h-screen pt-32 text-center"><p className="font-semibold">Unable to load this event.</p><Link href="/events" className="mt-4 inline-flex text-primary">Back to Events</Link></main> : (() => {
