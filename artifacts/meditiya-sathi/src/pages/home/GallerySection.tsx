...
function PhotoCard({ photo }: { photo: FeaturedPhoto }) {
  ...
  return <Link href={`/gallery/${encodeURIComponent(photo.albumSlug)}`} className="group relative block aspect-[4/3] overflow-hidden rounded-2xl border-white/[0.09] bg-black/[0.24] transition duration-300 hover:-translate-y-1 hover:border-amber-300/25 hover:shadow-[0_15px_45px_rgba(245,158,11,0.08)] dark:bg-white/[0.025]">
